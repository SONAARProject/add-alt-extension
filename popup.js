...
const disableTwitterDialogsCheckbox = document.getElementById(
  "disableTwitterDialogs"
);
const disableFacebookDialogsCheckbox = document.getElementById(
  "disableFacebookDialogs"
);
const disableTwitterDialogsCheckbox2 = document.getElementById(
  "disableTwitterDialogs2"
);
const disableFacebookDialogsCheckbox2 = document.getElementById(
  "disableFacebookDialogs2"
);
...
chrome.storage.sync.get("lang", function (item) {
  if (item.lang) {
    ...
    langSelect.value = langSelect2.value =
...
chrome.storage.sync.get("disableTwitterDialogs", function (item) {
  if (item.disableTwitterDialogs) {
    disableTwitterDialogsCheckbox.checked =
      disableTwitterDialogsCheckbox2.checked = true;
  }
});

chrome.storage.sync.get("disableFacebookDialogs", function (item) {
  if (item.disableFacebookDialogs) {
    disableFacebookDialogsCheckbox.checked =
      disableFacebookDialogsCheckbox2.checked = true;
  }
});
...
if (userId) {
  const ids = document.getElementsByClassName("userId");
  for (const id of ids) {
    id.innerHTML = userId;
  }
}
